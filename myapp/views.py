    ...
    if request.method=='POST':
        ...
        if pass1 !=pass2:
         ...
         return redirect('register')
            ...
            messages.warning(request,'Usename already taken')
            return redirect('register')
           ...
           user.save()
           messages.success(request,'request,User has been register successfully')
...
def delete(reques,id):
    blog=Blog.objects.get(id=id)
    blog.delete()
    messages.success(reques,'post has been deleted successfully')
    return redirect('/')
